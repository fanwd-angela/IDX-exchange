...
#  Load the combined MLS datasets
...
# Fetch weekly 30-year mortgage rates from FRED
...
#  Validate and rename mortgage-rate columns
...
# Validate required MLS date columns
...
# Create year-month keys in the MLS datasets
...
# Merge monthly mortgage rates onto both datasets
...
# Validate row counts after the merge
...
# Check for unmatched mortgage-rate values
